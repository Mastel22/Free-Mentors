...
describe('App: ', () => {
  ...
  //   chai.request(app).patch('/api/v1/user/46').set('token', adminToken).end((error, res) => {
  //     chai.expect(res.status).to.be.eq(200);
  ...
  //   chai.request(app).post('/api/v1/auth/signin').send({email: "Kari76@gmail.com", password: "0775315500"}).end((error, res) => {
